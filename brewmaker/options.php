...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Basic Settings', 'basic_settings'),
		'type' => 'heading');

	$options[] = array(
		'name' => __('Google Analytics', 'basic_settings'),
		'desc' => __('Your Google Analytics Key. Formet: UA-XXXXXXX-X', 'basic_settings'),
		'id' => 'google_analytics-ua',
		'std' => 'Default',
		'class' => 'mini',
		'type' => 'text');
//
