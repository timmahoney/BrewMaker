...
function optionsframework_options() {
    ...
    /**
     * Load Global Options from the parent theme
     */
    require (get_template_directory() . '/lib/options-framework/bm-global-options.php');
	...
	$options[] = array(
		...
		'desc' => 'A different mini text input field.',
